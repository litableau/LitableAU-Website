  ...
  return (
    <div id="home" className="w-full relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-8 left-8 w-1 h-1 bg-[#8B7355] rounded-full dot-glitter" style={{ animationDelay: '0s' }}></div>
        ...
        <div className="absolute top-20 left-56 w-2 h-2 bg-[#8B7355] rounded-full dot-bubble" style={{ animationDelay: '1.5s' }}></div>
        ...
        <div className="absolute top-14 right-28 w-1 h-1 bg-[#8B7355] rounded-full dot-twinkle" style={{ animationDelay: '0.7s' }}></div>
        ...
        <div className="absolute top-26 right-76 w-1.5 h-1.5 bg-[#8B7355] rounded-full dot-sparkle" style={{ animationDelay: '2.2s' }}></div>
        ...
        <div className="absolute top-55 left-32 w-1.5 h-1.5 bg-[#8B7355] rounded-full dot-float" style={{ animationDelay: '0.8s' }}></div>
        ...
        <div className="absolute top-85 left-80 w-1 h-1 bg-[#8B7355] rounded-full dot-glitter" style={{ animationDelay: '2.3s' }}></div>
        ...
        <div className="absolute top-40 right-20 w-1.5 h-1.5 bg-[#8B7355] rounded-full dot-float" style={{ animationDelay: '0.4s' }}></div>
        ...
        <div className="absolute top-70 right-68 w-1 h-1 bg-[#8B7355] rounded-full dot-glitter" style={{ animationDelay: '1.9s' }}></div>
        ...
        <div className="absolute top-45 left-1/3 w-1.5 h-1.5 bg-[#8B7355] rounded-full dot-float" style={{ animationDelay: '0.6s' }}></div>
        ...
        <div className="absolute top-75 left-3/4 w-1 h-1 bg-[#8B7355] rounded-full dot-twinkle" style={{ animationDelay: '2.1s' }}></div>
        
        <div className="absolute top-40 right-1/4 w-1.5 h-1.5 bg-[#D4A574] rounded-full dot-bubble" style={{ animationDelay: '0.3s' }}></div>
        <div className="absolute top-50 right-1/3 w-1 h-1 bg-[#8B7355] rounded-full dot-twinkle" style={{ animationDelay: '0.8s' }}></div>
        ...
        <div className="absolute top-80 right-3/4 w-1.5 h-1.5 bg-[#8B7355] rounded-full dot-sparkle" style={{ animationDelay: '2.3s' }}></div>
        ...
        <div className="absolute top-115 left-40 w-1.5 h-1.5 bg-[#8B7355] rounded-full dot-float" style={{ animationDelay: '0.7s' }}></div>
        ...
        <div className="absolute top-145 left-88 w-1 h-1 bg-[#8B7355] rounded-full dot-glitter" style={{ animationDelay: '2.2s' }}></div>
        
        {/* Lower Middle Area - Right Side */}
        <div className="absolute top-110 right-28 w-1.5 h-1.5 bg-[#8B7355] rounded-full dot-float" style={{ animationDelay: '0.4s' }}></div>
        ...
        <div className="absolute top-140 right-76 w-1 h-1 bg-[#8B7355] rounded-full dot-glitter" style={{ animationDelay: '1.9s' }}></div>
        ...
        <div className="absolute bottom-25 left-28 w-1.5 h-1.5 bg-[#8B7355] rounded-full dot-float" style={{ animationDelay: '0.6s' }}></div>
        ...
        <div className="absolute bottom-40 left-76 w-1 h-1 bg-[#8B7355] rounded-full dot-glitter" style={{ animationDelay: '2.1s' }}></div>
        <div className="absolute bottom-45 left-92 w-1.5 h-1.5 bg-[#D4A574] rounded-full dot-sparkle" style={{ animationDelay: '2.6s' }}></div>
        
        <div className="absolute bottom-18 right-16 w-1.5 h-1.5 bg-[#8B7355] rounded-full dot-float" style={{ animationDelay: '0.3s' }}></div>
        ...
        <div className="absolute bottom-33 right-64 w-1 h-1 bg-[#8B7355] rounded-full dot-glitter" style={{ animationDelay: '1.8s' }}></div>
