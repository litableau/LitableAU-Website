      ...
      className={`relative transition-all duration-500 shadow-lg font-argesta
        ${
          active
            ...
            : "w-10/12 sm:w-8/12 h-20 sm:h-24 landscape:h-28 bg-[#FBE8D8] rounded-full flex items-center justify-between px-6 hover:bg-[#7A806C] hover:text-[#FBE8D8]"
        }`}
    >
      {/* Collapsed View */}
      {!active && (
        <>
          <span
            className="text-lg sm:text-xl font-semibold tracking-wide cursor-pointer text-[#012D20] hover:text-[#FBE8D8] font-argesta"
      ...
      {active && (
        <>
          ...
          {/* Subheading */}
          <h3 className="text-base sm:text-lg text-center font-semibold text-[#E5C7B1] mt-2 font-argesta">
            Signature Events
          </h3>

          {/* Text Content */}
          <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-[#E5C7B1] scrollbar-track-[#012D20] pr-2 mt-4">
            <p className="leading-relaxed text-[#FBE8D8] font-argesta text-sm sm:text-base">
             ...
             <p className="leading-relaxed text-[#FBE8D8] font-argesta mt-2 text-sm sm:text-base">
